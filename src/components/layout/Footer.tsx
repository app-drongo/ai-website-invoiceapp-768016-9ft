...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Streamline your invoicing process with our modern, intuitive platform. Trusted by thousands of businesses to manage their billing efficiently and professionally.',
  ...
  social2Href: 'https://linkedin.com/company/invoiceflow',
  social3Href: '#',
  social4Href: '#',
  social5Href: '#',
  ...
  linkAbout: 'Terms',
  linkAboutHref: '#terms',
  linkBlog: 'Privacy Policy',
  linkBlogHref: '#privacy',
  linkCareers: '',
  linkCareersHref: '#',
  linkPress: '',
  linkPressHref: '#',
  ...
  linkTerms: 'Contact Support',
  linkTermsHref: '#contact',
  linkCookies: '',
  linkCookiesHref: '#',
  linkGdpr: '',
  linkGdprHref: '#',
